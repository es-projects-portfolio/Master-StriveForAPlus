<x-app-layout>
    @if(auth()->user()->is_admin && auth()->user()->category == 'lower_secondary')
        <x-slot name="header">
                        ...
                        <form action="{{ route('admin.createSection') }}" method="POST">
                            ...
                            <div class="mt-4">
                                ...
                                <select id="course_id" name="course_id" class="rounded">
                                    @foreach($courses->where('category', 'lower_secondary') as $course)
                        ...
                        <form action="{{ route('admin.assignStudentToSection') }}" method="POST">
                            ...
                            <div class="mt-4">
                                ...
                                <select id="section_id" name="section_id" class="rounded">
                                    @foreach($sections->where('course.category', 'lower_secondary') as $section)
